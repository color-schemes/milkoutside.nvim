# Milkoutside Theme for Obsidian

A dark, cosmic-inspired theme for Obsidian based on the [milkoutside.nvim](https://github.com/milkoutside/milkoutside.nvim) colorscheme.

This theme brings the elegant, muted color palette of milkoutside to your Obsidian workspace, providing a comfortable and visually appealing environment for note-taking and writing.
