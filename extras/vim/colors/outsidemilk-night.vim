...
hi BlinkCmpMenu guibg=NONE guifg=#c0caf5
hi BlinkCmpSignatureHelp guibg=NONE guifg=#c0caf5
...
hi DiagnosticVirtualTextError guibg=#160808 guifg=#db4b4b
hi DiagnosticVirtualTextHint guibg=#031310 guifg=#1abc9c
hi DiagnosticVirtualTextInfo guibg=#011316 guifg=#0db9d7
hi DiagnosticVirtualTextWarn guibg=#16120a guifg=#e0af68
hi DiagnosticWarn guibg=NONE guifg=#e0af68
hi DiffAdd guibg=#2a3f51
hi DiffChange guibg=#303a55
hi DiffDelete guibg=#3a2f40
...
hi FzfLuaFzfSeparator guibg=NONE guifg=#ff9e64
hi FzfLuaNormal guibg=NONE guifg=#c0caf5
hi FzfLuaTitle guibg=NONE guifg=#ff9e64
...
hi MiniDepsTitleError guibg=#914c54
...
hi MiniFilesTitleFocused gui=bold guibg=NONE
hi MiniHipatternsFixme gui=bold guibg=#db4b4b
hi MiniHipatternsHack gui=bold guibg=#e0af68
hi MiniHipatternsNote gui=bold guibg=#1abc9c
hi MiniHipatternsTodo gui=bold guibg=#0db9d7
...
hi MiniPickBorderText guibg=NONE guifg=#1abc9c
hi MiniPickPrompt guibg=NONE guifg=#0db9d7
...
hi MiniStatuslineInactive guibg=NONE guifg=#7aa2f7
hi MiniStatuslineModeCommand gui=bold guibg=#e0af68
hi MiniStatuslineModeInsert gui=bold guibg=#9ece6a
hi MiniStatuslineModeNormal gui=bold guibg=#7aa2f7
hi MiniStatuslineModeOther gui=bold guibg=#1abc9c
hi MiniStatuslineModeReplace gui=bold guibg=#f7768e
hi MiniStatuslineModeVisual gui=bold guibg=#bb9af7
hi MiniSurround guibg=#ff9e64
hi MiniTablineCurrent guibg=#3b4261 guifg=#c0caf5
hi MiniTablineHidden guibg=NONE guifg=#737aa2
hi MiniTablineModifiedCurrent guibg=#3b4261 guifg=#e0af68
hi MiniTablineModifiedHidden guibg=NONE guifg=#9d7a49
hi MiniTablineModifiedVisible guibg=NONE guifg=#e0af68
hi MiniTablineTabpagesection guibg=#3b4261
hi MiniTablineVisible guibg=NONE guifg=#c0caf5
...
hi NeogitDiffAddHighlight guibg=#2a3f51 guifg=#449dab
hi NeogitDiffContextHighlight guibg=#1e2131 guifg=#a9b1d6
hi NeogitDiffDeleteHighlight guibg=#3a2f40 guifg=#914c54
...
hi StatusLine guibg=NONE guifg=#a9b1d6
hi StatusLineNC guibg=NONE guifg=#3b4261
hi String guibg=NONE guifg=#9ece6a
hi Substitute guibg=#f7768e
hi TabLine guibg=NONE guifg=#3b4261
hi TabLineSel guibg=#7aa2f7
...
hi VertSplit guibg=NONE guifg=#545c7e
hi VimwikiHR guibg=NONE guifg=#e0af68
hi VimwikiHeader1 gui=bold guibg=NONE guifg=#f7768e
hi VimwikiHeader2 gui=bold guibg=NONE guifg=#ff9e64
hi VimwikiHeader3 gui=bold guibg=NONE guifg=#e0af68
hi VimwikiHeader4 gui=bold guibg=NONE guifg=#9ece6a
hi VimwikiHeader5 gui=bold guibg=NONE guifg=#7dcfff
hi VimwikiHeader6 gui=bold guibg=NONE guifg=#7aa2f7
hi VimwikiHeader7 gui=bold guibg=NONE guifg=#bb9af7
...
hi Visual guibg=#394b70
hi VisualNOS guibg=#394b70
hi WarningMsg guibg=NONE guifg=#e0af68
hi Whitespace guibg=NONE guifg=#3b4261
hi WildMenu guibg=#394b70
hi WinSeparator gui=bold guibg=NONE guifg=#545c7e
hi debugBreakpoint guibg=#011316 guifg=#0db9d7
hi debugPC guibg=#1f2335
hi diffAdded guibg=#2a3f51 guifg=#449dab
hi diffChanged guibg=#303a55 guifg=#6183bb
hi diffFile guibg=NONE guifg=#7aa2f7
hi diffIndexLine guibg=NONE guifg=#bb9af7
hi diffLine guibg=NONE guifg=#565f89
hi diffNewFile guibg=#2a3f51 guifg=#2ac3de
hi diffOldFile guibg=#3a2f40 guifg=#2ac3de
hi diffRemoved guibg=#3a2f40 guifg=#914c54
